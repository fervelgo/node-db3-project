...
function add(scheme) { // EXERCISE D
  return db('schemes')
    .insert(scheme)
    .then(([scheme_id]) => {
      return db('schemes'.where('scheme_id',scheme_id)).first() //the first() explicitly picks the first item, therefore you dont return an array, just that firsdt object
    })
